...
function initNavbarScroll() {
    ...
    function updateNavbar() {
        ...
        if (currentScrollY > 100) {
            ...
            nav.style.borderBottomColor = 'rgba(139, 92, 246, 0.5)';
...
// Оптимизированный 3D portfolio effect с поддержкой touch
function initPortfolioEffect() {
    document.querySelectorAll('.portfolio-item').forEach(item => {
        ...
        item.addEventListener('mousemove', function(e) {
            ...
            // Создаем новый кадр анимации для плавного обновления
            animationFrameId = requestAnimationFrame(() => {
                ...
                this.style.boxShadow = `
                    ${-rotateY}px ${rotateX}px 40px rgba(139, 92, 246, 0.25),
        ...
        item.addEventListener('touchstart', function(e) {
            ...
            `;
            this.style.boxShadow = `
                ${-rotateY}px ${rotateX}px 30px rgba(139, 92, 246, 0.3),
